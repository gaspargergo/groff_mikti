...
#running preconv, so refer can use the file with Hungarian chars as well, this temp file is hardcoded in the mom source file header
preconv $reference_folder/to_sc > $reference_folder/temp
...
pdfmom -P-e -k -R $source_file > document.pdf


#cleanup
rm $reference_folder/to_sc $reference_folder/temp
